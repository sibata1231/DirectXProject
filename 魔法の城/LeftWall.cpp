...
HRESULT LeftWall::Create(const char* passName, PrimitiveTypes primitiveType, ObjMaterial* material) {
    HRESULT hr      = S_OK;          
...
HRESULT LeftWall::CreateBumpMapTexture(const char* passName) {
...
// 頂点の作成
HRESULT LeftWall::MakeMeshVertex(POM_VERTEX vertexWk[], int indexWk[]) {
...
DirectX::XMFLOAT3 LeftWall::CalcTangent(POM_VERTEX p0, POM_VERTEX p1, POM_VERTEX p2) {
    // 5次元→3次元頂点に
