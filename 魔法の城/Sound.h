...
public:
	...
	static void Play(BgmDatas bgm);
	static void Play(SeDatas se);
	static bool IsPlaying(BgmDatas bgm);
	static void Stop(BgmDatas bgm);
	static void Stop(SeDatas se);
	static void Pause();
	static void Resume();
	static void SetVolume(float fVol);
	static float GetVolume();
	static void SetVolume(BgmDatas bgm, float fVol);
	static float GetVolume(BgmDatas bgm);
	static void SetVolume(SeDatas se, float fVol);
	static float GetVolume(SeDatas se);
};