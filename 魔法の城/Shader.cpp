...
static LPCWSTR g_pszCSODir = L"Resources\\shader\\";
	...
	const D3D11_INPUT_ELEMENT_DESC* pInpElemDesc, UINT uNumElem)
{
	...
	// シェーダバイナリ読み込み
	HINSTANCE hInst = Window::Instacne;
    HWND hWnd = FindWindow(Window::ClassName,nullptr);
	...
	// ブロブからバーテックスシェーダ作成
	ID3D11Device* pDevice = DirectGraphics::GetInstance().GetDevice();
